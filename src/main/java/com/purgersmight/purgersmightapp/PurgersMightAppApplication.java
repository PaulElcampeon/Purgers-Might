...
//
        ...
        Armour armour1 = new Armour.ArmourBuilder().setArmourType(ArmourType.HEAD).setArmourName("Picos").setArmourPoints(10).build();
        Armour armour2 = new Armour.ArmourBuilder().setArmourType(ArmourType.CHEST).setArmourName("Decos").setArmourPoints(10).build();

        angie1Ava.getBag().getInventory().add(armour1);
        angie1Ava.getBag().getInventory().add(armour2);
